...
\paragraph{Reception}
To gange årligt holder \TKET åbent hus, hvor ansatte, studerende og andre VIP'er inviteres til smørrebrød, portvin og en hyggelig eftermiddag på \TKET.
...
Første fest med den nye BESTyrelse. I 25/26 blev Halloweenfesten indført som en kombination mellem Stiftelsesfesten og Karnevalsfesten\footnote{Disse er beskrevet i næste afsnit}. Festen inkluderer mulighed for spisning, hvor der undervejs foregår spas og løjer fra BESTyrelsens(???) side, og efterfølgende fest med kostumekonkurrence.

\paragraph{Foredrag}
Hvert kvartal i bestyrelsesåret byder på et foredrag, hvor de studernede kan komme og blive underholdt med et emne der ikke er fagligt relevant. Foredragene spænder videt i emner og fra de sidste ti år har der blandt andre være foredrag ved følgende:
\begin{itemize}
    \item Søren Ryge
    \item Sigurd Barrett
...
\paragraph{Café Bagefter}
Efter hvert foredrag invitere \TKET både studerende og foredragsholder til at nyde en drikkevare og godtselskab i Café Bagefter, hvor der er mulighed for at spille brætspil og diskutere det netop afsluttede foredrag.
...
Den sidste studiedag i vintersemesteret afholder \TKET en Revy. Revyen indeholder sketche og (pause-)fisk som kan hænde at være baseret på hændelser der er sket på både nationalt og internationalt plan i løbet af det sidste halve år. Udover sketches vil der til denne revy også forekomme opvisning af cabaret dans, ofte mere behåret end man forventer. Revyen afsluttes med en hvid x-mas og efterfølgende fest.
...
\ldots (forårsfest ?? / vinterfest ?? / kissemissefest) Kært barn har mange navne.
