\section{Anekdoter}
I J50 skriftet var der indsamlet anekdoter fra hvert årti i \TKETs eksistens. Disse tekster er gengivet her. Vi har fået en person fra hver dekade af \TKETs eksistens til at skrive en lille tekst om tiden i \TKET . Vi starter med en historie fra en af \TKETs stiftere.

\subsection{1956-1966}
...
\begin{flushright}
    Per Mark, FORM 1956–1958
\end{flushright}

\subsection{1966-1976}
...
\begin{flushright}
    Mogens Kamstrup Erlandsen, SEKR 1971–1972
\end{flushright}

\subsection{1976–1986, Fra Crosby til Randers}
...
\subsubsection{Bundgaard, er du for gammel nu?}
...
\subsubsection{Kantinens 20 års-jubilæum}
...
\begin{flushright}
    Peter Fristrup, \CERM 1981–1982
\end{flushright}


\subsection{1986–1996, Night on Earth}
...
\begin{flushright}
    Niels Madsen, FORM 1991–1992, \KASS 1992–1993
\end{flushright}


\subsection{1996–2006, Historien om da \RemToR var til salg}

Ikke så længe efter at vores kære nation vandt EM i en velkendt sportsgren, der har to hold af 11, og noget luft med grisehud omkring som vigtigste elementer, var der en NF, opkaldt efter den lyd man siger når man har glemt at høre sin øl på en torsdag\ldots UPS!
...
Dette var vi nogle løbeseddelsafhængige kammersugere, der fandt værdigt for en straf. Denne skulle naturligvis bestå i at når NF’en kom hjem var \RemToR væk\ldots (vi var vist ikke de første, eller sidste, der lavede det nummer).

Dette var vi nogle løbeseddelsafhængige kammersugere, der fandt værdigt for en straf. Denne skulle naturligvis bestå i at når NF’en kom hjem var \RemToR væk\ldots (vi var vist ikke de første, eller sidste, der lavede det nummer).

Men men, i vores Ceres-fremkaldte klarsyn indså vi straks, at inden vi overtalte \RemToR til at gemme sig måtte vi have en plan. Indtagelsen af flydende og hørt inspiration fremkaldte lidt efter en plan; snedig i sin enkelhed\ldots\RemToR skulle sættes til salg i Stakbogladen!

Endnu et par kolde Ceres kom på bordkanten, og snart indså vi illegale kombattanter at et passende gemmmested også var en nødvendighed. Hvad var mere naturligt end at finde en kontorbesiddende person i Næstformationens komplement? Vores første kandidat var med på ideen! Denne person var på daværende tidspunkt desuden med i Fysisk Fredagsbar, og foreslog derfor at deres lagerrum var et godt gemmested.
...
\begin{flushright}
    Peter Juhl Christansen, \VC 1996–1997, FORM 1997–1998
\end{flushright}
...
I 2008 arrangerede vi et foredrag (om Takt og Tone), som viste sig at være kortere, end hvad vi plejede - så vi besluttede at fylde tiden ud med en omgang Lanciers i solgården. Det blev kun bedre af, at en af vores trofaste hængere havde en mor, der kunne levere undervisning og levende musik. Det var tænkt som en nødløsning for at lappe på et for kort foredrag, men nu runder vi snart 20 år med årlige Lanciers-aftener på kammeret, og egentlig kan man vel kun undre sig over, at det tog os så længe at starte den hyggelige tradition.
...
I starten af 2007 fik nogle hængere en idé til at lave sjov med \CERM{}. De ville bilde hende ind, at hun var ved at glemme en elsket tradition på kammeret, som hun naturligvis havde ansvaret for at videreføre: fejringen af 47. dag - med sanghæfte, særligt kreeret happeningssang og naturligvis indtagning af Carlsberg 47 i rigelige mængder. De udnyttede i den sammenhæng, at den pågældende \CERM har gået direkte fra FU til BEST, så de satsede på, hun ikke kunne huske, om der havde været holdt 47. dag året inden. \CERM faldt i med begge ben, men da hun faktisk var på vej på ferie, blev det en temmelig stressende opgave for hende at få skrevet en sang, og den blev afleveret på vej til stationen. I et sjældent tilfælde af dårlig samvittighed skrev hængerne derfor de sidste ti års happeningssange på vegne af de gamle \CERM{}er, så der kunne skabes et ægte sanghæfte. Jeg husker ikke, hvornår \CERM indså, at hun var blevet snøret - men siden da er 47. dag blevet fejret med manér og ny happeningssang hvert eneste år! 

\begin{flushright}
    Ninni Duch Schaldemose, SEKR 2007-2008
\end{flushright}


\subsection{2016-2026}
I løbet af det sidste årti har den fredelige studentertilværelse stået for skud. Studietiden er blevet kortere, SU'en er blevet mindre og drikkevarerne er blevet dyrere. Denne sørgelige udvikling kunne ses allerede tilbage i 2017, og \TKET rakte derfor en hjælpende hånd ud til de studerende: I løbet af en eksamensperiode kunne den flittige hænger optjene kammer-ECTS! Således kunne man, med nok kammer-ECTS, optjene en Bachelor \TK-studier. Pensum for dette studie lød på at hjælpe BEST med at passe på vores lokaler og kammer-ECTS blev derfor optjent ved for eksempel at tømme en skraldespand, fylde et køleskab, hælde sjatter ud, osv.

Udover disse praktiske foretagender skulle man jo nødigt glemme at der ligger mere i \TKET end at holde lokalet rent, så man kunne også optjene kammer-ECTS ved at bunde en drikkevare, ringe med klokken, eller købe sig af tavlen. Hængerne lurede hurtigt at deltagelse til et torsdagsmøde kunne kreditere den tørstige og gavmilde hænger med omtrent lige så mange kammer-ECTS som hvis man gjorde rent efter et torsdagsmøde. Det skulle selvfølgelig testes om den optimale måde at få en Bachelor i \TK-studier var ved druk eller rengøring, og således blev der drukket rigtig mange øl på et rigtig rent kammer. I årene efter er kammer-ECTS vendt tilbage, dog med et utal at ændringer til studiestrukturen som vi kender det fra resten af Aarhus Universitet, så de kammer-ECTS gyldige opgaver og deres omfang ændre sig fra eksamensperiode til eksamensperiode.

%\TKETs medlemmer passer også deres normale studie, og herunder skal en studerende kunne præsentere og formidle den viden de har erhvervet sig. På fysik tog dette formen af at kandidatstuderne skulle afholde et åbent studenterkollokvium om et selvalgt emne, som ofte lå som det sidste faglige punkt på dagen. For hængerne på \TKET var dette en oplagt mulighed for at se deres venner fremvise deres faglige kunnen og samtidig nyde en fyraftensøl i godt selskab. Dette udviklede sig dog ret hurtigt til, at den studerende, der skulle afholde foredraget, sammensatte en liste med dongord, som de fremmødte hængere skulle drikke på. Et eksempel på hvor effektiv en fyraftensaktivit dette er, er undertegnedes eget studenterkollokvium i 2018, som omhandlede elektrostatiske krafter og bier. Ved slutningen af dette ca. 30 min foredrag havde fOrm 2021/2022 tømt ca. en halv kasse på egen hånd. Da han allerede var godt igang, besluttede vi os for at tage videre på kammeret for at fortsætte fejringen af et veloverstået studenterkollokvium.

I BEST-året 2019/2020 blev verden underlagt Corona\footnote{Det bør nævnes at skylden for dette ikke ligger hos BEST 19/20, de var bare utroligt uheldige.}, og \TKET kom til at føle det i form af nedlukning af Aarhus Universitet, begrænsing af sociale arrangementer, og social distancering. Som respons på de nye omstændigheder viste \TKET sig fra sin standhaftige side og de fleste af vores faste arrangementer bleve stadig afholdt, bare med gentænkte formater.

Torsdagsmøderne blev afholdt online som videomøder, hvor den uagtsomme hænger hurtigt kunne blive fanget i at spise på kamera. Dette nye format var særdeles velegnet til at møderne blev afholdt halv otte. Denne periode bød på et større antal morgenmøder end man var vant til, hvor man ofte kunne se hængere ligge under dynen eller være iklædt pyjamas.

Udover torsdagsmøderne blev mange andre arrangementer også gentænkt, hvilket førte til at revyen blev streamet, hvor alle sketches, sange og fisk var blevet optaget på forhånd, og man gjorde så vidt muligt brug af at revy i dette format ikke var bundet til en scene. Dette blev demonstreret nydeligt under julerevyen 2020, hvor den traditionelle can-can blev danset på flere lokationer rundt omkring i Aarhus by.

BEST-året 2020/2021 var domineret af Corona-restriktioner. Dette førte til at HSTR blev omlagt til at hængerne i mange små grupper tog på diskrete men simultane skovture, under BODYCRASHING blev hver disciplin filmet separat og samlet til en online stream, og mange mindre arrangementer blev til online møder. Det skete dog at restriktionerne begyndet at lette hen mod slutningen af BEST-året 2020/21, og hængere kunne glædes ved igen at kunne mødes på Kammeret\footnote{Dog kun fire hængere ad gangen da social distancering ikke tillod flere personer på kammerets knap 16 m$^2$.}. Lettelsen af restriktionerne resulterede i en eksplosion af social aktivitet omkring \TKET og i løbet af ca. en månedes tid blev der afholdt en fest, et foredrag, en (sen) løvfaldstur, SØØL, Rushyg, en kasse i \KASS, TK-Open og samtlige torsdagsmøder blev holdt udenfor. Der gik ikke længe efter restriktionerne var løftet helt indtil dagligdagen omkring \TKET var tilbage.

Kort efter GF i 2021, befandt der sig et antal \VC'er på kammeret, og køleskabet var ekstra fyldt. Inspireret af lignende begivenheder i Fysisk Fredags bar besluttede de sig for at forsøge at drikke en af hver af øllene i køleskabet, dvs. de tog på Tour de Fridge. Det skal bemærkes at \TKET på dette tidspunkt havde et stort udvalg af juleøl udover det normale sortiment, hvilket betød at øllene på ruten havde en gennemsnitlig alkoholprocent på ca. 6\%. Dette har dog aldrig afskrækket andet end de mest fornuftige hængere. Flere hængere sluttede sig til etapen i løbet af aftenen, og trods at der var mange folk til stede, og det var forsøgt at føre regnskab i løbet af aftenen, kan ingen rigtig huske om routen blev gennemført; En udpræget success. Tour de Fridge er sporadisk vendt tilbage til kammeret gennem årene og succesen er blevet gentaget hver gang.

Den første onsdag i maj tester Beredskabsstyrelsen og Rigspolitiet varslingssirenerne rundt omkring i landet, hvilket jo kan være til en vis gene og overraskelse, hvis man sidder dybt begravet i ens studier. Denne årlige støjgene spidse til i 2022 da \CERM{}LAUGET, i et ukarakteristisk øjeblik af fremadrettet planlægning, besluttede sig for at teste deres trutte-evner overfor en værdig modstander: Den nærmeste varslingssirene.

Således troppede et kampklart segment af \CERM{}LAUGET op i uniparken, den første onsdag i maj 2022, armeret med horn og hornforstærkere \footnote{En trafikkegle.}. På slaget tolv gik både sirener og horn i gang, og efter adskillige lange minutters trut, måtte de tilstedeværende \CERM{}'er og \VC{}'er desværre erklære sig slået; Teknologien havde slået det ellers elegante signalhorn\ldots Den sørgelige konklusion varede dog ikke længere end indtil de slåede krigere var hjemvendt på Kammeret, da der prompte kom en ansat fra Matematisk institut ind for at levere en lydklage over \CERM{}LAUGETs trut, da man jo ikke kunne arbejde i den larm og derudover var det også svært at høre sirenetesten. Humøret vendt hurtigt og ligeså den første elephantøl i en triumferende sejersbunding. Siden denne sejr har \CERM{}LAUGET testet deres horn hvert år, den første onsdag i maj, dog uden yderligere klager fra ansatte.

\begin{flushright}
    Simon Bølling Nordentoft, \VC 2020–2021
\end{flushright}

\tkpicture[0.9\linewidth]{../img/løbeseddel_5}
\tkpicture[0.9\linewidth]{../img/løbeseddel_6}
