...
Langt de fleste kender ``fire på stribe" som et kedeligt og simpelt spil, der hører til i børnehaven. Med ganske små modifikationer bliver det dog udfordrende og ikke-trivielt. Vi vil i det følgende vise et par varianter af spillet. Det forudsættes at læseren er bekendt med de sædvanlige regler:
\begin{itemize}
...
{\scriptsize$\bigcirc$} vinder i torus varianten.
\end{minipage}
\begin{minipage}{0.45\textwidth}
\centering
\begin{tabular}{|c|c|c|c|c|c|c|}
...
{\scriptsize$\bigcirc$} vinder i Möbius varianten.
\end{minipage}
\newline\newline
...
$\times$ vinder i bounce varianten.
\end{minipage}
\begin{minipage}{0.45\textwidth}
\centering
\begin{tabular}{|c|c|c|c|c|c|c|}
...
Alternativt, kan man, i tilfælde af et ulige antal spillere, skiftes til at droppe en brik, mens farveordenen opretholdes, således at farverne skiftes til at komme i. Herved vil hver spille skiftevis droppe forskellige farver i rammen. Den person, som lægger vinderbrikken, vinder, resten taber. God fornøjelse.