...
Et træk i Neutrino foregår således: Først flyttes neutrinoen i en af de otte retninger (som dronningen i skak) så langt som den kan, inden den støder på en forhindring, hvorefter spilleren flytter en af sine egne brikker på samme måde. En forhindring betyder enten kanten af spillepladen, eller en anden brik. Efter den første tur kan spillepladen altså fx se ud som en af de tre første illustrationer herunder. Derimod kan spillepladen efter første træk ikke se ud som illustrationen længst til højre, idet neutrinoen ikke er blevet rykket helt til venstre.
